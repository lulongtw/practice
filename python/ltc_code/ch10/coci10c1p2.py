...
# There are only 5 different grades; for each one, we can find the maximum
# number of consecutive desks that contain a student with that grade.
# The solution is then the maximum of these 5 results.
...
for grade in range(1, 6):  # Try each of the 5 possible grades
